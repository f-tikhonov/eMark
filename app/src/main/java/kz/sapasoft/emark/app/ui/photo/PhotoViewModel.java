...
public final class PhotoViewModel extends BaseViewModel {
    ...
    @Inject
    public PhotoViewModel(PrefsImpl prefsImpl2, Context context2, BaseCloudRepository baseCloudRepository2) {
    ...
    public final void login(String str, String str2, String str3) {
        ...
        if (verifyAvailableNetwork()) {
            launchIO(new PhotoViewModel$login$1(this, str3, str, str2, (Continuation) null));
