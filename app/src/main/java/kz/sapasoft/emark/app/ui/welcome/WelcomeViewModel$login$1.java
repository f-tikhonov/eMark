...
/* JADX INFO: super call moved to the top of the method (can break code semantics) *//*
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        WelcomeViewModel$login$1 welcomeViewModel$login$1 = new WelcomeViewModel$login$1(this.this$0, this.$server, this.$username, this.$password, continuation);
        welcomeViewModel$login$1.p$ = (CoroutineScope) obj;
        return welcomeViewModel$login$1;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((WelcomeViewModel$login$1) create(obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (resultWrapper instanceof ResultWrapper.Error) {
            ...
            Config.INSTANCE.setDOMAIN(this.$server + "/service/");
