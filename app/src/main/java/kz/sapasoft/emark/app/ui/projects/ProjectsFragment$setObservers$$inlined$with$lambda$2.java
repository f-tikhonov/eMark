...
final class ProjectsFragment$setObservers$$inlined$with$lambda$2<T> implements Observer<List<? extends ProjectModel>> {
    ...
    public final void onChanged(List<ProjectModel> list) {
        ...
        if (!list.isEmpty()) {
            this.this$0.getAdapter().add(list);
        }
    }
}
